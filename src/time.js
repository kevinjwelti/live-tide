...
export function skyPalette(date) {
  ...
  return {
    ...
    photo: {
      hue: -6 * cool - 6 * nightW,
      sat: 1 - 0.08 * cool - 0.5 * nightW,
      bright: (1 - nightW) * (1.08 + 0.42 * cool) + 0.36 * nightW,
      contrast: 1.1 + 0.12 * cool - 0.1 * nightW,
    },
    overlay: rgb(mix(mixed.zenith, mixed.horizon, 0.35)),
    overlayAlpha: 0.46 * cool,
    overlayMode: "color",
    skyWash: 0.38 * cool,
    screenLift: 0.14 * cool,
    waterWash: 0.3 * cool,
    skyCover: 0.58 * cool,
    sunHide: 0.92 * cool * (1 - warm),
    vignette: Math.min(1, 0.14 + 0.86 * (1 - cool) + 0.12 * nightW),
